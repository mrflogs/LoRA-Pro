...
def main():
    ...
    # Step 6: Save model
    if local_rank == 0:
        model.save_pretrained(f'./logs/transformers/llama-2-7b/chat/{args.lora}/{args.seed}')
        tokenizer.save_pretrained(f'./logs/transformers/llama-2-7b/chat/{args.lora}/{args.seed}')
